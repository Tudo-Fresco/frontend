...
export async function getPosts(storeUUID: string, page: number = 1, pageSize: number = 100, radiusMeters: number = 10000, productType: ProductType = ProductType.ANY, demandStatus: DemandStatus = DemandStatus.OPENED): Promise<Array<DemandResponseModel>> {
